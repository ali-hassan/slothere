...
export class SearchPageComponent extends Component {
  constructor(props) {
    ...
    this.setState({showMapButtonText: 'Show map'}); 
  }
  ...
  render() {
    ...
    const onShowMapClick = () => {
      if(this.state.shouldShowSearchMap){
        this.setState({showMapButtonText: 'Show map'}); 
        this.setState({shouldShowSearchMap: false}); 
      }else{
        this.setState({showMapButtonText: 'Close map'}); 
        this.setState({shouldShowSearchMap: true});
      }
    }
    ...
    const showMapButtonText = this.state.shouldShowSearchMap ? this.state.showMapButtonText : 'Show Map';
      ...
      >
        ...
        <div className={css.container}>
          <MainPanel
            ...
            showMapButtonText={showMapButtonText}
          ...
          >
            <div className={css.mapWrapper}>
              {this.state.shouldShowSearchMap ? (
                <SearchMap
