...
export const filters = [
  ...
  //     options: [
  //       { key: 'home', label: 'Home Studio' },
  //       { key: 'mid_level', label: 'Mid-Level Studio' },
  //       { key: 'kundalini', label: 'Kundalini' },
  //       { key: 'podcast_space', label: 'Podcast Space' },
  //       { key: 'rehearsal_space', label: 'Rehearsal Space' },
...
//         { key: '200h', label: 'Option1' },
//         { key: '500h', label: 'Option2' },
//       ],
//     },
//   },
