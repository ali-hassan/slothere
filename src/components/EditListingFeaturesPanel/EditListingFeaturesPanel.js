...
const EditListingFeaturesPanel = props => {
  ...
  const main_equipment = publicData && publicData.main_equipment;
  const initialValues = { amenities, main_equipment };
  ...
  return (
    <div className={classes}>
      ...
      <EditListingFeaturesForm
        ...
        onSubmit={values => {
          const { amenities = '', main_equipment = '' } = values;

          const updatedValues = {
            publicData: { amenities, main_equipment },
          };
