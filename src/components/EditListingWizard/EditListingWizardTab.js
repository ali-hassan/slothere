...
export const STUDIORULES = 'studiorules';
...
const EditListingWizardTab = props => {
  ...
  switch (tab) {
    ...
    case STUDIORULES: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditListingWizard.saveNewStudioRules'
        : 'EditListingWizard.saveEditStudioRules';
      return (
        <EditListingStudioRulesPanel
          {...panelProps(STUDIORULES)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
          onSubmit={values => {
            onCompleteEditListingWizardTab(tab, values);
          }}
